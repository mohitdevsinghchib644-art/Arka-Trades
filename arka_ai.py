...
def save_rule_to_memory(rule_type: str, rule_name: str, rule_text: str, tags: list = None) -> bool:
    ...
    try:
        ...
        if embedding is None:
            st.error("Engine failed to generate vector embeddings for this input.")
            return False
...
def generate_chart_notes(img: "Image.Image", user_note: str = "") -> str:
    ...
    try:
        prompt = (
            ...
            "candlestick patterns, volume behavior, trend structure, "            "indicator readings, key price levels, and any notable anomalies. "            "Be precise and factual. 4-6 bullet points maximum. "            "No advice, no recommendations, no emotional language."
