            ...
            if results:
                ...
                for i, s in enumerate(filtered):
                    ...
                    card = (
                        ...
                        f'<span style="font-family:Inter,sans-serif;font-weight:900;font-size:12px;'
                        f'color:{IVORY};white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:80px;">'
                        f'{s["sym"]}</span>'
                        f'{dot}'
