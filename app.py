            ...
            if results:
                ...
                for i, s in enumerate(filtered):
                    ...
                    card = (
                        ...
                        f'<span style="font-family:Inter,sans-serif;font-weight:900;font-size:13px;'
                        f'color:{IVORY};white-space:nowrap;">'
                        f'{s["sym"]}</span>'
                        f'{dot}'
                        f'<span style="display:flex;align-items:center;flex-shrink:0;">{bell}</span>'
                        f'</div>'
                        f'<div style="font-family:JetBrains Mono,monospace;font-size:11px;font-weight:700;'
                        f'color:{cc};margin-bottom:6px;">{arr}{abs(s["chg"]):.2f}%</div>'
                        f'<div style="font-family:JetBrains Mono,monospace;font-weight:700;font-size:14px;'
                        f'color:{IVORY};line-height:1;margin-bottom:6px;">&#8377;{s["cur"]:.2f}</div>'
                        f'<div style="font-family:JetBrains Mono,monospace;font-size:11px;font-weight:700;'
